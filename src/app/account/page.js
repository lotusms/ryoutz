  ...
  return (
    <div className="relative mx-auto max-w-4xl">
      ...
      <div className="relative mt-14 grid gap-5 sm:grid-cols-2">
        <Link
          href="/account/orders"
          className="group relative overflow-hidden rounded-3xl border border-white/10 bg-linear-to-br from-stone-900/90 to-stone-950/95 p-8 shadow-xl shadow-stone-950/40 ring-1 ring-white/5 transition hover:border-amber-400/35 hover:ring-amber-400/25"
        >
          <div
            aria-hidden
        ...
        <Link
          href="/gallery"
          className="group relative overflow-hidden rounded-3xl border border-white/10 bg-linear-to-br from-stone-900/80 to-stone-950/90 p-8 shadow-xl shadow-stone-950/40 ring-1 ring-white/5 transition hover:border-sky-400/25 hover:ring-sky-400/15"
        >
          <div
            aria-hidden
