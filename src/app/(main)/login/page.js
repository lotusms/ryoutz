...
export default function LoginPage() {
  ...
  const { user, loading, accountLoading, isAdmin, signIn, firebaseEnabled } =
    useAuth();
    ...
    return (
      ...
      >
        <p className="max-w-md text-sm leading-relaxed">
          Sign-in is not configured for this deployment. Add Firebase environment
          variables to <code className="rounded bg-black/10 px-1 py-0.5 text-xs dark:bg-white/10">.env.local</code>{" "}
