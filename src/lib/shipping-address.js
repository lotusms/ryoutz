...
/**
 * Normalize region for US/CA addresses (2-letter state/province codes).
 * Kept as `normalizeStateCodeForPrintful` for existing call sites (checkout, quotes).
 */
...
/** Checkout-friendly digits-only phone (no parentheses). */
...
/** Checkout listbox options; `code` is USPS-style for US. */
