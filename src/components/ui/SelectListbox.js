...
const DEFAULT_ANCHOR = {
  to: "bottom start",
  gap: 4,
  /** viewport edge inset for flip/shift + Floating UI `size` middleware */
  padding: 12,
};
...
export default function SelectListbox({
  ...
  const resolvedOptionsClassName = `${basePanelClassName} ${overlayChrome.listboxDropdownScrollArea()}`;
