...
export default function InnerPageBackdrop({ light = false }) {
  if (light) {
    return (
      ...
      >
        ...
        <div className="animate-aura-2 absolute right-0 top-32 h-96 w-96 rounded-full bg-blue-300/20 blur-3xl" />
  ...
  return (
    ...
    >
      ...
      <div className="animate-aura-2 absolute right-0 top-32 h-96 w-96 rounded-full bg-blue-400/12 blur-3xl" />
